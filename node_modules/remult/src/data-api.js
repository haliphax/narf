...
var DataApi = /** @class */ (function () {
    ...
    DataApi.prototype.httpGet = function (res, req, serializeContext) {
        ...
        if (action === null || action === void 0 ? void 0 : action.startsWith(rest_data_provider_1.liveQueryAction))
            return this.liveQuery(res, req, undefined, serializeContext, action.substring(rest_data_provider_1.liveQueryAction.length));
        switch (action) {
            case 'get':
            case 'count':
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (action === null || action === void 0 ? void 0 : action.startsWith(rest_data_provider_1.liveQueryAction))
                            return [2 /*return*/, this.liveQuery(res, req, body, serializeContext, action.substring(rest_data_provider_1.liveQueryAction.length))];
                        _a = action;
                        switch (_a) {
    ...
    DataApi.prototype.getArrayImpl = function (response, request, filterBody) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        findOptions = { load: function () { return []; } };
                        _a = findOptions;
                        return [4 /*yield*/, this.buildWhere(request, filterBody)];
                    case 1:
                        _a.where = _b.sent();
                        ...
                        hasId_1 = false;
                        return [4 /*yield*/, filter_interfaces_1.Filter.fromEntityFilter(this.repository.metadata, findOptions.where)];
                    case 2:
                        w = _b.sent();
                        if (w) {
                            w.__applyToConsumer({
                        ...
                        if (!hasId_1) {
                            response.forbidden();
                            throw new server_action_1.ForbiddenError();
                        }
                        _b.label = 3;
                ...
                switch (_b.label) {
                    ...
                    case 3:
                        data = (_a.requestJson = _b.sent(),
                            _a.findOptionsJson = (0, rest_data_provider_1.findOptionsToJson)(r.findOptions, this.repository.metadata),
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        if (request) {
                            where.push((0, filter_interfaces_1.buildFilterFromRequestParameters)(this.repository.metadata, {
                                get: function (key) {
                                    var result = request.get(key);
                                    if (key.startsWith(filter_interfaces_1.customUrlToken) &&
                                        result &&
                        ...
                        if (filterBody)
                            where.push(filter_interfaces_1.Filter.entityFilterFromJson(this.repository.metadata, filterBody));
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        result_1 = [];
                        return [4 /*yield*/, (0, context_1.doTransaction)(this.remult, function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                var body_1, body_1_1, item, _a, _b, e_1_1;
                                var e_1, _c;
