        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, this.liveQueryStorage().forEach(entityKey, function (_a) {
                                            ...
                                            return [4 /*yield*/, this.performWithContext(query.requestJson, entityKey, function (repo) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                                    ...
                                                    return tslib_1.__generator(this, function (_e) {
                                                        switch (_e.label) {
                                                            case 0:
                                                                messages = [];
                                                                return [4 /*yield*/, repo.find((0, rest_data_provider_1.findOptionsFromJson)(query.findOptionsJson, repo.metadata))];
                                                            case 1:
