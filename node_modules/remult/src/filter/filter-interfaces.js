...
exports.__updateEntityBasedOnWhere = exports.buildFilterFromRequestParameters = exports.entityFilterToJson = exports.FilterSerializer = exports.customDatabaseFilterToken = exports.customUrlToken = exports.OrFilter = exports.AndFilter = exports.filterHelper = exports.Filter = void 0;
            ...
            if (Object.prototype.hasOwnProperty.call(whereItem, key)) {
                var fieldToFilter_1 = whereItem[key];
                {
                    if (key == '$or') {
                        ...
                        var fh = new filterHelper(entity.fields[key]);
                        var found = false;
                        if (fieldToFilter_1 !== undefined && fieldToFilter_1 != null) {
                            if (fieldToFilter_1.$id)
...
var filterHelper = /** @class */ (function () {
    ...
    filterHelper.prototype.processVal = function (val) {
        var ei = (0, getEntityRef_1.getEntitySettings)(this.metadata.valueType, false);
        if (ei) {
            if (!val)
                return null;
            if (typeof val === 'string' || typeof val === 'number')
                return val;
            return (0, getEntityRef_1.getEntityRef)(val).getId();
        }
        return val;
    };
