...
var SqlDatabase = /** @class */ (function () {
    ...
    SqlDatabase.filterToRaw = function (repo, condition, sqlCommand) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var r, b, _a, _b;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        r = (0, RepositoryImplementation_1.getRepository)(repo);
                        _a = filter_consumer_bridge_to_sql_request_1.FilterConsumerBridgeToSqlRequest.bind;
                        _b = [void 0, sqlCommand];
                        return [4 /*yield*/, (0, filter_consumer_bridge_to_sql_request_1.dbNamesOf)(r.metadata)];
                    case 1:
                        b = new (_a.apply(filter_consumer_bridge_to_sql_request_1.FilterConsumerBridgeToSqlRequest, _b.concat([_c.sent()])))();
                        b._addWhere = false;
                        return [4 /*yield*/, r.translateWhereToFilter(condition)];
                    case 2: return [4 /*yield*/, (_c.sent()).__applyToConsumer(b)];
                    case 3:
                        _c.sent();
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                        ...
                        if (this.logToConsole !== false) {
                            ...
                            if (d > SqlDatabase.durationThreshold) {
                                ...
                                if (this.logToConsole === 'oneLiner') {
                                    ...
                                    console.info({ query: sql, arguments: this.args, duration: duration });
                                }
                            }
                        }
                        return [2 /*return*/, r];
                    case 2:
                        err_1 = _a.sent();
                        console.error({ error: err_1, query: sql, arguments: this.args });
                        throw err_1;
...
var ActualSQLServerDataProvider = /** @class */ (function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        wc = new filter_consumer_bridge_to_sql_request_1.FilterConsumerBridgeToSqlRequest(r, e);
    ...
    ActualSQLServerDataProvider.prototype.find = function (options) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var e, _a, colKeys, select, r, where, _b, first, segs, _loop_1, _c, _d, s, segs_1, segs_1_1, c, page;
            var e_2, _e, e_3, _f;
            var _this = this;
            return tslib_1.__generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        ...
                        where = new filter_consumer_bridge_to_sql_request_1.FilterConsumerBridgeToSqlRequest(r, e);
                    ...
                    case 3:
                        ...
                        if (options.orderBy) {
                            ...
                            segs = [];
                            _loop_1 = function (s) {
                                if (s.field instanceof CompoundIdField_1.CompoundIdField) {
                                    segs.push.apply(segs, tslib_1.__spreadArray([], tslib_1.__read(s.field.fields.map(function (c) { return ({
                                        field: c,
    ...
    ActualSQLServerDataProvider.prototype.update = function (id, data) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var e, r, f, statement, added, _a, _b, x, v, _c, _d, colKeys, select;
            var e_5, _e;
            var _this = this;
            return tslib_1.__generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 1:
                        e = _f.sent();
                        r = this.sql.createCommand();
                        f = new filter_consumer_bridge_to_sql_request_1.FilterConsumerBridgeToSqlRequest(r, e);
                        ...
                        try {
                            for (_a = tslib_1.__values(this.entity.fields), _b = _a.next(); !_b.done; _b = _a.next()) {
                                x = _b.value;
                                if (x instanceof CompoundIdField_1.CompoundIdField) {
                                }
                                if ((0, filter_consumer_bridge_to_sql_request_1.isDbReadonly)(x, e)) {
                                }
            ...
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, r
                                .execute(statement)
                                .then(function (sql) { return _this.buildResultRow(colKeys, sql.rows[0], sql); })];
                        ...
                        return tslib_1.__generator(this, function (_d) {
                            switch (_d.label) {
                                case 0:
                                    ...
                                    c = db.createCommand();
                                    _b = 'insert into ';
                                    return [4 /*yield*/, items[0]._.metadata.getDbName()];
                                case 1:
                                    _c = _b +
                                        (_d.sent()) +
                                        ' (';
                                    return [4 /*yield*/, Promise.all(items[0]._.metadata.fields.toArray().map(function (f) { return f.getDbName(); }))];
                                case 2:
                                    sql = _c +
                                        (_d.sent()).join(',') +
                                        ') values ';
