...
var RestDataProvider = /** @class */ (function () {
    ...
    RestDataProvider.prototype.getEntityDataProvider = function (entity) {
        ...
        return new RestEntityDataProvider(function () {
            ...
            return (0, buildRestDataProvider_1.buildRestDataProvider)(_this.apiProvider().httpClient);
        }, entity);
    };
...
function findOptionsToJson(options, meta) {
    var r = tslib_1.__assign(tslib_1.__assign({}, options), { where: filter_interfaces_1.Filter.entityFilterToJson(meta, options.where) });
    if (options.load)
        r.load = options.load(meta.fields).map(function (y) { return y.key; });
    return r;
}
...
function findOptionsFromJson(json, meta) {
    ...
    var r = {};
    try {
        for (var _b = tslib_1.__values(['limit', 'page', 'where', 'orderBy']), _c = _b.next(); !_c.done; _c = _b.next()) {
            var key = _c.value;
            if (json[key] !== undefined) {
                if (key === 'where') {
                    r[key] = filter_interfaces_1.Filter.entityFilterFromJson(meta, json.where);
                }
                else
                    r[key] = json[key];
            }
...
var RestEntityDataProvider = /** @class */ (function () {
    ...
    RestEntityDataProvider.prototype.buildFindRequest = function (options) {
        ...
        var run = function (action) {
            var u = new urlBuilder_1.UrlBuilder(url.url);
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, {
                                    ...
                                    unsubscribe: function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                        var _this = this;
                                        return tslib_1.__generator(this, function (_a) {
                                            return [2 /*return*/, server_action_info_1.actionInfo.runActionWithoutBlockingUI(function () {
...
var RestDataProviderHttpProviderUsingFetch = /** @class */ (function () {
    ...
    RestDataProviderHttpProviderUsingFetch.prototype.get = function (url) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, buildRestDataProvider_1.retry)(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                            return tslib_1.__generator(this, function (_a) {
    ...
    RestDataProviderHttpProviderUsingFetch.prototype.post = function (url, data) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, buildRestDataProvider_1.retry)(function () {
...
function addFilterToUrlAndReturnTrueIfSuccessful(filter, url) {
    ...
    var _loop_1 = function (key) {
        if (Object.prototype.hasOwnProperty.call(filter, key)) {
            ...
            else if (key.startsWith(filter_interfaces_1.customUrlToken))
                url.add(key, JSON.stringify(element));
            else
                url.add(key, element);
        }
