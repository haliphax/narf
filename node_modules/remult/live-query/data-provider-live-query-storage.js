...
var initDataProvider_1 = require("../server/initDataProvider");
...
var DataProviderLiveQueryStorage = /** @class */ (function () {
    function DataProviderLiveQueryStorage(dataProvider) {
        this.dataProvider = (0, initDataProvider_1.initDataProvider)(dataProvider);
        this.repo = this.dataProvider.then(function (dp) {
            return new context_1.Remult(dp).repo(LiveQueryStorageEntity);
        });
    }
...
var LiveQueryStorageEntity = /** @class */ (function (_super) {
    ...
    tslib_1.__decorate([
        RepositoryImplementation_1.Fields.object(),
        tslib_1.__metadata("design:type", Object)
...
}(RepositoryImplementation_1.EntityBase));
exports.LiveQueryStorageEntity = LiveQueryStorageEntity;
context_1.allEntities.splice(context_1.allEntities.indexOf(LiveQueryStorageEntity), 1);
