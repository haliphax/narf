...
var MongoDataProvider = /** @class */ (function () {
    function MongoDataProvider(db, client, options) {
        ...
        this.disableTransactions = options === null || options === void 0 ? void 0 : options.disableTransactions;
    }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 11];
                    case 2: return [4 /*yield*/, this.client.startSession()];
                    case 3:
                        session = _a.sent();
...
var MongoEntityDataProvider = /** @class */ (function () {
    ...
    MongoEntityDataProvider.prototype.translateToDb = function (row, nameProvider) {
        ...
        try {
            for (var _b = tslib_1.__values(this.entity.fields), _c = _b.next(); !_c.done; _c = _b.next()) {
                var col = _c.value;
                var val = col.valueConverter.toDb(row[col.key]);
                if (val === null)
                    val = NULL;
    ...
    MongoEntityDataProvider.prototype.update = function (id, data) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, collection, e, f, resultFilter, _b, _c, x, newR, keys, _d, _e, f_1, r, _f, _g;
            var e_4, _h, e_5, _j;
            return tslib_1.__generator(this, function (_k) {
                switch (_k.label) {
                    case 0: return [4 /*yield*/, this.collection()];
                    case 1:
                        _a = _k.sent(), collection = _a.collection, e = _a.e;
                        f = new FilterConsumerBridgeToMongo(e);
                        _1.Filter.fromEntityFilter(this.entity, this.entity.idMetadata.getIdFilter(id)).__applyToConsumer(f);
                        ...
                        try {
                            for (_b = tslib_1.__values(this.entity.fields), _c = _b.next(); !_c.done; _c = _b.next()) {
                                x = _c.value;
                                if (x instanceof _1.CompoundIdField) {
                                    resultFilter = (0, resultCompoundIdFilter_1.resultCompoundIdFilter)(x, id, data);
                                }
                            }
                        }
                        ...
                        try {
                            for (_d = tslib_1.__values(this.entity.fields), _e = _d.next(); !_e.done; _e = _d.next()) {
                                f_1 = _e.value;
                                if (!f_1.dbReadOnly && !f_1.isServerExpression) {
                                    if (keys.includes(f_1.key)) {
                                        newR[f_1.key] = f_1.valueConverter.toDb(data[f_1.key]);
                                    }
                                }
                            }
                        }
                        ...
                        _g = (_f = collection).updateOne;
                        return [4 /*yield*/, f.resolveWhere()];
                    case 2: return [4 /*yield*/, _g.apply(_f, [_k.sent(), {
                                $set: newR,
                            },
                            { session: this.session }])];
                    case 3:
                        ...
                        return [2 /*return*/, this.find({
                                where: _1.Filter.fromEntityFilter(this.entity, resultFilter),
...
var FilterConsumerBridgeToMongo = /** @class */ (function () {
    ...
    FilterConsumerBridgeToMongo.prototype.or = function (orElements) {
        ...
        this.promises.push((function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var result, orElements_1, orElements_1_1, element, f, where, e_7_1;
            var e_7, _a;
            var _b;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        where = _c.sent();
                        if (((_b = where === null || where === void 0 ? void 0 : where.$and) === null || _b === void 0 ? void 0 : _b.length) > 0) {
                            result.push(where);
                        }
                        else
        ...
        this.result.push(function () {
            ...
            return (_a = {},
                _a[_this.nameProvider.$dbNameOf(col)] = {
                    $in: val.map(function (x) { return col.valueConverter.toDb(x); }),
                },
                _a);
        });
    };
    ...
    FilterConsumerBridgeToMongo.prototype.add = function (col, val, operator) {
        var _this = this;
        this.result.push(function () {
            var _a, _b;
            return (_a = {},
                _a[_this.nameProvider.$dbNameOf(col)] = (_b = {},
                    _b[operator] = isNull(val) ? val : col.valueConverter.toDb(val),
                    _b),
                _a);
        });
    };
