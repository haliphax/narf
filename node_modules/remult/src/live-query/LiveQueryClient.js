...
var LiveQueryClient = /** @class */ (function () {
    ...
    LiveQueryClient.prototype.subscribe = function (repo, options, listener) {
        ...
        this.runPromise(repo
            .buildEntityDataProviderFindOptions(options)
            .then(function (opts) {
            if (!alive)
                return;
            var _a = new rest_data_provider_1.RestDataProvider(_this.apiProvider)
            ...
            if (!q) {
                _this.queries.set(eventTypeKey, (q = new SubscriptionChannel_1.LiveQuerySubscriber(repo, { entityKey: repo.metadata.key, options: options }, _this.getUserId())));
                ...
                return tslib_1.__generator(this, function (_j) {
                    switch (_j.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, Promise.resolve().then(function () { return tslib_1.__importStar(require('../server-action-info')); })];
                        case 1:
                            actionInfo = (_j.sent()).actionInfo;
                            _c = this.runPromise;
                            return [4 /*yield*/, actionInfo.runActionWithoutBlockingUI(function () {
                                    return (0, buildRestDataProvider_1.buildRestDataProvider)(p_1.httpClient).post(p_1.url + '/' + SubscriptionChannel_1.liveQueryKeepAliveRoute, ids);
                                })];
