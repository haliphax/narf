            ...
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        _a = tslib_1.__values(tslib_1.__spreadArray([], tslib_1.__read(context_1.allEntities), false).reverse()), _b = _a.next();
                        _d.label = 2;
                    case 2:
                                        ...
                                        case 0:
                                            ...
                                            try {
                                                for (_a = tslib_1.__values(entity.fields), _b = _a.next(); !_b.done; _b = _a.next()) {
                                                    x = _b.value;
                                                    if (!(0, filter_consumer_bridge_to_sql_request_1.isDbReadonly)(x, e) || (0, RepositoryImplementation_1.isAutoIncrement)(x)) {
                                                        if (result.length != 0)
                                                            result += ',';
                                                        result += '\r\n  ';
                                            ...
                                            sql = "CREATE table ".concat(this.schemaAndName(e), " (").concat(result, "\r\n)");
            ...
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 4:
                        ...
                        col = _b.value;
                        if (!!(0, filter_consumer_bridge_to_sql_request_1.isDbReadonly)(col, e)) return [3 /*break*/, 6];
