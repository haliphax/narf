...
exports.processHttpException = exports.toPromise = exports.retry = exports.HttpProviderBridgeToRestDataProviderHttpProvider = exports.isExternalHttpProvider = exports.buildRestDataProvider = void 0;
var tslib_1 = require("tslib");
var rest_data_provider_1 = require("./data-providers/rest-data-provider");
function buildRestDataProvider(provider) {
    if (!provider)
        return new rest_data_provider_1.RestDataProviderHttpProviderUsingFetch();
    ...
    if (!httpDataProvider) {
        if (typeof provider === 'function') {
            httpDataProvider = new rest_data_provider_1.RestDataProviderHttpProviderUsingFetch(provider);
        }
    }
