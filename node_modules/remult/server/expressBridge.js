...
exports.JobsInQueueEntity = exports.EntityQueueStorage = exports.RemultServerImplementation = exports.createRemultServerCore = void 0;
var tslib_1 = require("tslib");
var SseSubscriptionServer_1 = require("../SseSubscriptionServer");
var context_1 = require("../src/context");
var data_api_1 = require("../src/data-api");
var SubscriptionChannel_1 = require("../src/live-query/SubscriptionChannel");
var SubscriptionServer_1 = require("../src/live-query/SubscriptionServer");
var RepositoryImplementation_1 = require("../src/remult3/RepositoryImplementation");
var entity_1 = require("../src/remult3/entity");
var getEntityRef_1 = require("../src/remult3/getEntityRef");
var server_action_1 = require("../src/server-action");
var server_action_info_1 = require("../src/server-action-info");
var initDataProvider_1 = require("./initDataProvider");
function createRemultServerCore(options, serverCoreOptions) {
    ...
    if (!options.subscriptionServer) {
        options.subscriptionServer = new SseSubscriptionServer_1.SseSubscriptionServer();
    }
    if (options.logApiEndPoints === undefined)
        options.logApiEndPoints = true;
    server_action_info_1.actionInfo.runningOnServer = true;
    if (options.defaultGetLimit) {
        data_api_1.DataApi.defaultGetLimit = options.defaultGetLimit;
    }
    if (!options.queueStorage) {
        options.queueStorage = new InMemoryQueueStorage();
    }
    var dataProvider = (0, initDataProvider_1.initDataProvider)(options.dataProvider);
    if (options.ensureSchema === undefined)
        options.ensureSchema = true;
    context_1.RemultAsyncLocalStorage.enable();
    ...
    dataProvider = dataProvider.then(function (dp) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    remult = new context_1.Remult(dp);
                    return [4 /*yield*/, new Promise(function (res) {
                            context_1.RemultAsyncLocalStorage.instance.run(remult, function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                var started_1, startConsoleLog, _a, _b, item, e_1_1;
                                var e_1, _c;
    ...
    }); });
    {
        var allControllers = [];
        if (!options.entities)
            options.entities = tslib_1.__spreadArray([], tslib_1.__read(context_1.allEntities), false);
        if (options.entities)
    ...
    server_action_info_1.actionInfo.runningOnServer = true;
    var bridge = new RemultServerImplementation(new inProcessQueueHandler(options.queueStorage), options, dataProvider, serverCoreOptions, entitiesMetaData);
    return bridge;
}
exports.createRemultServerCore = createRemultServerCore;
/* @internal*/
var RemultServerImplementation = /** @class */ (function () {
    function RemultServerImplementation(queue, options, dataProvider, coreOptions, entitiesMetaData) {
        var _this = this;
        this.queue = queue;
        ...
        this.liveQueryStorage = new SubscriptionServer_1.InMemoryLiveQueryStorage();
        this.runWithSerializedJsonContextData = function (jsonContextData, entityKey, what) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _loop_1, this_1, _a, _b, e, state_1, e_2_1;
            var e_2, _c;
            var _this = this;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _loop_1 = function (e) {
                            ...
                            return tslib_1.__generator(this, function (_e) {
                                switch (_e.label) {
                                    case 0:
                                        key = (0, getEntityRef_1.getEntityKey)(e);
    ...
    RemultServerImplementation.prototype.withRemultPromise = function (request, what) {
        var _this = this;
    ...
    RemultServerImplementation.prototype.registerRouter = function (r) {
        ...
        this.registeredRouter = true;
        {
            try {
                for (var _c = tslib_1.__values(this.options.controllers), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var c = _d.value;
                    var z = c[server_action_1.classBackendMethodsArray];
                    if (z)
                        try {
                            for (var z_1 = (e_4 = void 0, tslib_1.__values(z)), z_1_1 = z_1.next(); !z_1_1.done; z_1_1 = z_1.next()) {
                                var a = z_1_1.value;
                                var x = a[server_action_info_1.serverActionField];
                                if (!x) {
            ...
            if (this.hasQueue)
                this.addAction({
                    __register: function (x) {
                        x(server_action_1.Action.apiUrlForJobStatus, false, function () { return true; }, function (data, req, res) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                            var job, userId;
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
            ...
            if (this.options.subscriptionServer instanceof SseSubscriptionServer_1.SseSubscriptionServer) {
                var streamPath = this.options.rootPath + '/' + SubscriptionChannel_1.streamUrl;
            ...
            r.route(this.options.rootPath + '/' + SubscriptionChannel_1.liveQueryKeepAliveRoute).post(this.process(function (remult, req, res, reqInfo, origRes, origReq) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                var _a, _b, _c, _d;
                return tslib_1.__generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
        ...
        this.options.entities.forEach(function (e) {
            var key = (0, getEntityRef_1.getEntityKey)(e);
            if (key != undefined)
                _this.add(key, function (c) {
                    return new data_api_1.DataApi(c.repo(e), c);
                }, r);
        });
    };
    ...
    RemultServerImplementation.prototype.runWithRemult = function (what) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var remult, _a;
            var _this = this;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        remult.liveQueryPublisher = new SubscriptionServer_1.LiveQueryPublisher(function () { return remult.subscriptionServer; }, function () { return remult.liveQueryStorage; }, this.runWithSerializedJsonContextData);
                        _a = remult;
...
var ExpressResponseBridgeToDataApiResponse = /** @class */ (function () {
    ...
    ExpressResponseBridgeToDataApiResponse.prototype.error = function (data) {
        var _a;
        data = (0, data_api_1.serializeError)(data);
        console.error({
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this.actions.get(url)(body, req, {
                            error: function (error) { return job.setErrorResult((0, data_api_1.serializeError)(error)); },
...
var EntityQueueStorage = /** @class */ (function () {
    ...
    EntityQueueStorage.prototype.getJobInfo = function (queuedJobId) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repo.findId(queuedJobId, { useCache: false })];
                    case 1:
                        q = _a.sent();
...
var JobsInQueueEntity = /** @class */ (function (_super) {
    ...
    tslib_1.__decorate([
        RepositoryImplementation_1.Fields.string(),
    ...
    tslib_1.__decorate([
        RepositoryImplementation_1.Fields.date(),
    ...
    tslib_1.__decorate([
        RepositoryImplementation_1.Fields.boolean(),
    ...
    tslib_1.__decorate([
        RepositoryImplementation_1.Fields.number(),
        tslib_1.__metadata("design:type", Number)
    ], JobsInQueueEntity.prototype, "progress", void 0);
    JobsInQueueEntity = tslib_1.__decorate([
        (0, entity_1.Entity)(undefined, {
            dbName: 'jobsInQueue',
        })
    ], JobsInQueueEntity);
    return JobsInQueueEntity;
}(RepositoryImplementation_1.IdEntity));
exports.JobsInQueueEntity = JobsInQueueEntity;
context_1.allEntities.splice(context_1.allEntities.indexOf(JobsInQueueEntity), 1);
