...
var SseSubscriptionClient = /** @class */ (function () {
    ...
    SseSubscriptionClient.prototype.openConnection = function (onReconnect) {
        ...
        var provider = (0, buildRestDataProvider_1.buildRestDataProvider)(remult_proxy_1.remult.apiClient.httpClient);
        var connected = false;
        var source;
        var client = {
            close: function () {
                            ...
                            case 2:
                                ...
                                return [2 /*return*/, function () {
                                        ...
                                        if (listeners.length == 0) {
                                            server_action_info_1.actionInfo.runActionWithoutBlockingUI(function () {
                                                return provider.post(remult_proxy_1.remult.apiClient.url + '/' + SubscriptionChannel_1.streamUrl + '/unsubscribe', {
                                                    channel: channel,
        ...
        var createConnectionPromise = function () {
            return new Promise(function (res) {
                ...
                function createConnection() {
                    ...
                    if (source)
                        source.close();
                    source = new EventSource(remult_proxy_1.remult.apiClient.url + '/' + SubscriptionChannel_1.streamUrl, {
        ...
        function subscribeToChannel(channel) {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, server_action_info_1.actionInfo.runActionWithoutBlockingUI(function () {
                                return provider.post(remult_proxy_1.remult.apiClient.url + '/' + SubscriptionChannel_1.streamUrl + '/subscribe', {
                                    channel: channel,
                                    clientId: connectionId,
                                });
                            })];
