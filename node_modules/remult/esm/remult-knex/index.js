...
import { dbNamesOf, isDbReadonly, } from '../src/filter/filter-consumer-bridge-to-sql-request';
import { customDatabaseFilterToken, Filter, } from '../src/filter/filter-interfaces';
import { CompoundIdField } from '../src/CompoundIdField';
import { remult as remultContext } from '../src/remult-proxy';
import { getRepository, isAutoIncrement, } from '../src/remult3/RepositoryImplementation';
...
export class KnexDataProvider {
    ...
    static async filterToRaw(entity, condition) {
        ...
        b._addWhere = false;
        await (await repo.translateWhereToFilter(condition)).__applyToConsumer(b);
...
class KnexEntityDataProvider {
    ...
    async init() {
        return (await dbNamesOf(this.entity));
    }
