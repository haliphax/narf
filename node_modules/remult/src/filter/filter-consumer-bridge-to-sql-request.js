...
exports.dbNamesOf = exports.isDbReadonly = exports.CustomSqlFilterBuilder = exports.FilterConsumerBridgeToSqlRequest = void 0;
...
var CustomSqlFilterBuilder = /** @class */ (function () {
    ...
    CustomSqlFilterBuilder.prototype.filterToRaw = function (repo, condition) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, sql_database_1.SqlDatabase.filterToRaw(repo, condition, this)];
            });
        });
    };
...
function dbNamesOf(repo) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    meta = (0, RepositoryImplementation_1.getEntityMetadata)(repo);
                    _e = {};
                    return [4 /*yield*/, meta.getDbName()];
                case 1:
                ...
                case 3:
                    ...
                    _c = result;
                    _d = field.key;
                    return [4 /*yield*/, field.getDbName()];
                case 4:
                    _c[_d] = _g.sent();
                    _g.label = 5;
                case 5:
