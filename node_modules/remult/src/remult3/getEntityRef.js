...
exports.entityMember = Symbol('entityMember');
exports.entityInfo = Symbol('entityInfo');
exports.entityInfo_key = Symbol('entityInfo_key');
function getEntitySettings(entity, throwError) {
    ...
    if (entity === undefined)
        if (throwError) {
            ...
            return undefined;
    var info = Reflect.getMetadata(exports.entityInfo, entity);
    if (!info && throwError)
...
function getEntityKey(entity) {
    return Reflect.getMetadata(exports.entityInfo_key, entity);
}
