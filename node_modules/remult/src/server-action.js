                ...
                switch (_a.label) {
                    case 0:
                        if (baseUrl === undefined)
                            baseUrl = remult_proxy_1.remult.apiClient.url;
                        if (!http)
                            http = (0, buildRestDataProvider_1.buildRestDataProvider)(remult_proxy_1.remult.apiClient.httpClient);
                        return [4 /*yield*/, http.post(baseUrl + '/' + this.actionUrl, pIn)];
                    case 1:
                        r = _a.sent();
                        p = r;
                        if (!(p && p.queuedJobId)) return [3 /*break*/, 6];
                        progress_1 = server_action_info_1.actionInfo.startBusyWithProgress();
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, , 4, 5]);
                        return [4 /*yield*/, server_action_info_1.actionInfo.runActionWithoutBlockingUI(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, context_1.doTransaction)(remult, function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                var _a, _b, err_2;
...
function Controller(key) {
    return function (target, context) {
        ...
        (0, context_1.setControllerSettings)(target, { key: key });
        return target;
    };
}
...
function BackendMethod(options) {
    ...
    return function (target, context, descriptor) {
        ...
        (0, RepositoryImplementation_1.checkTarget)(target);
        if (target.prototype !== undefined) {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, server_action_info_1.actionInfo.runActionWithoutBlockingUI(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
            ...
            result = function () {
                ...
                return tslib_1.__awaiter(this, void 0, void 0, function () {
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!!(0, context_1.isBackend)()) return [3 /*break*/, 2];
            ...
            result[server_action_info_1.serverActionField] = serverAction_1;
            if (descriptor) {
        ...
        if (!x) {
            x = new context_1.ClassHelper();
            context_1.classHelpers.set(target.constructor, x);
        }
        var serverAction = {
            __register: function (reg) {
                var e_1, _a;
                var _this = this;
                var c = new context_1.Remult();
                        ...
                        return tslib_1.__generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    _a.trys.push([1, 3, , 4]);
                                    remult_1 = req;
                                    return [4 /*yield*/, (0, context_1.doTransaction)(remult_1, function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                                ...
                                                switch (_e.label) {
                                                    ...
                                                    case 6:
                                                        if (!remult_1.isAllowedForInstance(y, allowed))
                                                            throw new ForbiddenError();
                                                        defs = (0, getEntityRef_1.getEntityRef)(y);
                                                    ...
                                                    case 13:
                                                        ...
                                                        controllerRef = (0, RepositoryImplementation_1.getControllerRef)(y, remult_1);
                    ...
                    return tslib_1.__generator(this, function (_h) {
                        switch (_h.label) {
                            case 0:
                                ...
                                defs = (0, getEntityRef_1.getEntityRef)(self);
                                return [4 /*yield*/, defs.__validateEntity()];
                            case 1:
                                _h.sent();
                            ...
                            case 8:
                                defs = (0, RepositoryImplementation_1.getControllerRef)(self, undefined);
                                _h.label = 9;
                            case 9:
        ...
        result = function () {
            ...
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!!(0, context_1.isBackend)()) return [3 /*break*/, 1];
                            self_1 = this;
        ...
        result[server_action_info_1.serverActionField] = serverAction;
        if (descriptor) {
            descriptor.value = result;
            return descriptor;
        }
...
function registerAction(target, resultMethod) {
    ...
    server_action_info_1.actionInfo.allActions.push(resultMethod);
}
...
function prepareArgsToSend(types, args) {
    ...
    if (types) {
        for (var index = 0; index < types.length; index++) {
            ...
            try {
                for (var _b = (e_3 = void 0, tslib_1.__values([context_1.Remult, sql_database_1.SqlDatabase])), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var type = _c.value;
            ...
            if (args[index] != undefined) {
                ...
                x = (0, RepositoryImplementation_1.decorateColumnSettings)(x, new context_1.Remult());
                var eo = (0, getEntityRef_1.getEntitySettings)(paramType, false);
                if (eo != null) {
                    var rh = (0, getEntityRef_1.getEntityRef)(args[index]);
                    args[index] = rh.getId();
                }
                if (x.valueConverter)
        ...
        return tslib_1.__generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    if (!(types[i] == context_1.Remult || types[i] == context_1.Remult)) return [3 /*break*/, 2];
                    args[i] = remult;
                    return [3 /*break*/, 6];
                case 2:
                ...
                case 4:
                    x = { valueType: types[i] };
                    x = (0, RepositoryImplementation_1.decorateColumnSettings)(x, remult);
                    if (x.valueConverter)
                        args[i] = x.valueConverter.fromJson(args[i]);
                    eo = (0, getEntityRef_1.getEntitySettings)(types[i], false);
...
exports.classBackendMethodsArray = Symbol('classBackendMethodsArray');
