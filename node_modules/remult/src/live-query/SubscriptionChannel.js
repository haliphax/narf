    ...
    LiveQuerySubscriber.prototype.setAllItems = function (result) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repo.fromJsonArray(result, this.query.options.load)];
                    case 1:
                        items = _a.sent();
        ...
        what(function (reducer) {
            ...
            if (changes.find(function (c) { return c.type === 'add' || c.type === 'replace'; })) {
                if (_this.query.options.orderBy) {
                    var o_1 = sort_1.Sort.translateOrderByToSort(_this.repo.metadata, _this.query.options.orderBy);
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.repo.fromJsonArray(x.map(function (m) { return m.data.item; }), this.query.options.load)];
                    case 1:
                        loadedItems = _a.sent();
...
var SubscriptionChannel = /** @class */ (function () {
    ...
    SubscriptionChannel.prototype.publish = function (message, remult) {
        remult = remult || remult_proxy_1.remult;
