...
import { InMemoryLiveQueryStorage, LiveQueryPublisher, } from '../src/live-query/SubscriptionServer';
...
export function createRemultServerCore(options, serverCoreOptions) {
    ...
    actionInfo.runningOnServer = true;
    let bridge = new RemultServerImplementation(new inProcessQueueHandler(options.queueStorage), options, dataProvider, serverCoreOptions, entitiesMetaData);
    return bridge;
}
/* @internal*/
export class RemultServerImplementation {
    ...
    constructor(queue, options, dataProvider, coreOptions, entitiesMetaData) {
        this.queue = queue;
    ...
    withRemultPromise(request, what) {
