...
function remultGraphql(options) {
    ...
    if (!options.getRemultFromRequest) {
        options.getRemultFromRequest = function () { return index_1.remult; };
    }
    ...
    try {
        ...
        for (var _h = tslib_1.__values(['String', 'Int', 'Float', 'Boolean', 'ID']), _j = _h.next(); !_j.done; _j = _h.next()) {
            ...
            if (whereType === 'String') {
                try {
                    for (var _p = (e_4 = void 0, tslib_1.__values(['contains'])), _q = _p.next(); !_q.done; _q = _p.next()) {
                    ...
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                dApi = new data_api_1.DataApi(repo, remult);
...
function bridgeQueryOptionsToDataApiGet(arg1) {
    var limit = arg1.limit, page = arg1.page, orderBy = arg1.orderBy, where = arg1.where;
    return function (key) {
        if (limit && key === '_limit') {
            return limit;
        }
