...
exports.doTransaction = exports.EventSource = exports.queryConfig = exports.Allow = exports.setControllerSettings = exports.ClassHelper = exports.classHelpers = exports.allEntities = exports.Remult = exports.isBackend = exports.RemultAsyncLocalStorage = void 0;
var tslib_1 = require("tslib");
var rest_data_provider_1 = require("./data-providers/rest-data-provider");
var LiveQueryClient_1 = require("./live-query/LiveQueryClient");
var SseSubscriptionClient_1 = require("./live-query/SseSubscriptionClient");
...
var RemultAsyncLocalStorage = /** @class */ (function () {
    ...
    RemultAsyncLocalStorage.enable = function () {
        ;
        remult_proxy_1.remult.remultFactory = function () {
    ...
    RemultAsyncLocalStorage.disable = function () {
        ;
        remult_proxy_1.remult.resetFactory();
    };
...
function isBackend() {
    return server_action_info_1.actionInfo.runningOnServer || !remult_proxy_1.remult.dataProvider.isProxy;
}
...
var Remult = /** @class */ (function () {
    function Remult(provider) {
        ...
        this.dataProvider = new rest_data_provider_1.RestDataProvider(function () { return _this.apiClient; });
        /* @internal */
        ...
        /* @internal*/
        this.liveQuerySubscriber = new LiveQueryClient_1.LiveQueryClient(function () { return _this.apiClient; }, function () { var _a; return (_a = _this.user) === null || _a === void 0 ? void 0 : _a.id; });
        ...
        this.apiClient = {
            url: '/api',
            subscriptionClient: new SseSubscriptionClient_1.SseSubscriptionClient(),
        };
        if (provider && provider.getEntityDataProvider) {
            this.dataProvider = provider;
            return;
        }
        if ((0, buildRestDataProvider_1.isExternalHttpProvider)(provider)) {
    ...
    Remult.prototype.call = function (backendMethod, classInstance) {
        ...
        var z = backendMethod[server_action_info_1.serverActionField];
        if (!z.doWork)
            throw Error('The method received is not a valid backend method');
        //@ts-ignore
        return z.doWork(args, classInstance, this.apiClient.url, (0, buildRestDataProvider_1.buildRestDataProvider)(this.apiClient.httpClient));
    };
    Remult.prototype.clearAllCache = function () {
        this.repCache.clear();
    };
    Remult.run = function (callback, options) {
...
remult_proxy_1.RemultProxy.defaultRemultFactory = function () { return new Remult(); };
exports.allEntities = [];
...
var Allow = /** @class */ (function () {
    ...
    Allow.authenticated = function () {
        ...
        return remult_proxy_1.remult.authenticated();
    };
    return Allow;
}());
exports.Allow = Allow;
